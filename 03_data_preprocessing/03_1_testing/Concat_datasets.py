...
# Open config file
with open("03_data_preprocessing/March21_MdlPwr_MdlBatPwr/config_concat_datasets.yml", "r") as stream:
    ...
    def load_datasets(self):
        ...
        for dataset in dataset_list:
            ...
            for sample in sample_list:
                print(sample)
                single_sample_arr = np.array(pd.read_csv(os.path.join(dataset_path, sample), delimiter=','))
