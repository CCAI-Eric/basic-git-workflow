...
VSlopAFinPosn = pd.read_csv(
    "sample_VSlopAFinPosn_AitmContnsHorzn_sindelfingen.csv", delimiter=","
)
SlopFinVal = pd.read_csv(
    "sample_SlopFinVal_AitmContnsHorzn_sindelfingen.csv", delimiter=","
)
...
Tm_AmbAirP = pd.read_csv(
    "sample_Tm_AmbAirP_AitmContnsHorzn_sindelfingen.csv", delimiter=","
)
VSlopAFinVectLen = pd.read_csv(
    "sample_VSlopAFinVectLen_AitmContnsHorzn_sindelfingen.csv", delimiter=","
)
Tm_AmbAirTp = pd.read_csv(
    "sample_Tm_AmbAirTp_AitmContnsHorzn_sindelfingen.csv", delimiter=","
)
MVeh = pd.read_csv("sample_MVeh_AitmContnsHorzn_sindelfingen.csv", delimiter=",")
Cod_Diff_Ratio_Calc = pd.read_csv(
    "sample_Cod_Diff_Ratio_Calc_AitmContnsHorzn_sindelfingen.csv", delimiter=","
)
CurbWeight = pd.read_csv(
    "sample_CurbWeight_AitmContnsHorzn_sindelfingen.csv", delimiter=","
)
WhlPA_Circumfer = pd.read_csv(
    "sample_WhlPA_Circumfer_AitmContnsHorzn_sindelfingen.csv", delimiter=","
)
