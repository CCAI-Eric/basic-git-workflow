...
# Laden der Daten
VSlopAFinVectLen = np.genfromtxt('/home/ase/Dokumente/AITM/Daten/02_dataset/Mdl_Pwr/sindelfingen/sample_VSlopAFinVectLen_AitmContnsHorzn_sindelfingen.csv', delimiter=',')
sample_filter_dict = {0: "VSlopAFinPosn", 1: "SlopFinVal",2: "VFinVal", 3: "AFinVal"} # TODO: Add label channels
label_filter_dict = {0: "NEng", 1: "T", 2: "TqEng",3: "VVeh", 4: "GrSt"}
constant_dict = {0: "MVeh", 1: "Tm_AmbAirP", 2: "Tm_AmbAirTp", 3: "VSlopAFinVectLen", 4: "Cod_Diff_Ratio_Calc", 5: "CurbWeight", 6: "WhlPA_Circumfer"}
