...
os.chdir(
    "/home/ase/Dokumente/eh_basics/masterarbeit_eh/02_dataset/Mdl_Pwr_MdlBatPwr/206-505_210303_1354_simulated"
)
df = pd.read_csv(
    "label_AitmContnsHorzn_VVehAry200.csv",
    delimiter=",",
    sep=".",
    header=None,
    encoding="utf-8",
...
plt.ylabel("Counts (-)")
plt.title(
    "Häufigkeitsverteilung VVeh (km/h) für die Testfahrt 03.03.21 - alle Ereignisse [i]",
    size=16,
)
plt.show()
