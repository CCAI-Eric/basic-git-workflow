...
test_samples = genfromtxt(
    "us_test_samples_[0]_6outs_50%_filter_MdlPwr300_20a_7.1.csv", delimiter=","
)
test_labels = genfromtxt(
    "us_test_labels_[0]_6outs_50%_filter_MdlPwr300_20a_7.1.csv", delimiter=","
)
train_samples = genfromtxt(
    "us_train_samples_[0]_6outs_50%_filter_MdlPwr300_20a_7.1.csv", delimiter=","
)
train_labels = genfromtxt(
    "us_train_labels_[0]_6outs_50%_filter_MdlPwr300_20a_7.1.csv", delimiter=","
)
...
os.chdir(
    "/home/ase/Dokumente/eh_basics/masterarbeit_eh/03_data_preprocessing/testing/scaler"
)
