...
# Open config file
with open(
    "03_data_preprocessing/config_Preprocess_Data_fcnn_combination_v2.yml", "r"
) as stream:
...
class Preprocessing:
    ...
    def save_data(self):
        os.chdir(
            "/home/ase/Dokumente/eh_basics/masterarbeit_eh/02_dataset/Kombination_MdlPwr_MdlBatPwr/original_structure/AitmContsHorzn_MdlPwr_MdlBatPwr_Cnstr_BatCnstr_2019-12-20 11_41_53gaertringen_mit_routenfuehrung"
        )
